...
use crate::schema::{
    is_valid_field_name, vector_options, DateOptions, FacetOptions, FieldType, JsonObjectOptions,
    NumericOptions, TextOptions, VectorOptions,
};
...
impl FieldEntry {
    ...
    /// Creates a field entry for a vector field
